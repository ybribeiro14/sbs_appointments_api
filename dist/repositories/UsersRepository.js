...
var User_1 = __importDefault(require("../models/entities/User"));
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.findByLogin = function (login, contract_id) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ormRepository.findOne({
                                where: { login: login, contract_id: contract_id },
                            })];
                    case 1:
                        findUser = _a.sent();
                        return [2 /*return*/, findUser];
    ...
    UsersRepository.prototype.list = function (contract_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
