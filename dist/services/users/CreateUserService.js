...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        var name = _a.name, login = _a.login, password = _a.password, contract_id = _a.contract_id, permission_id = _a.permission_id, spawn_module = _a.spawn_module, loading_module = _a.loading_module, inventory_module = _a.inventory_module, painel_adm = _a.painel_adm, concierge = _a.concierge, checker = _a.checker, supervisor = _a.supervisor;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, this.usersRepository.findByLogin(login, contract_id)];
                    case 2:
