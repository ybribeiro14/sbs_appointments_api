...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        var login = _a.login, password = _a.password, contract_id = _a.contract_id;
        return __awaiter(this, void 0, void 0, function () {
            var contractsRepository, contract, user, passwordMatched, _b, expiresIn, secret, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        contractsRepository = new ContractsRepository_1.default();
                        return [4 /*yield*/, contractsRepository.findById(contract_id)];
                    case 1:
                        contract = _c.sent();
                        if (!contract) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, { user: user, token: token, contract: contract }];
                }
            });
        });
    };
